                        ...
                        <div class="card-body">
                            ...
                            @csrf
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="number" step="0.0001" class="form-control" name="value" value="{{ old('value') }}" required>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="number" class="form-control" name="min_nights" value="{{ old('min_nights') }}">
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="number" class="form-control" name="max_uses_per_email" value="{{ old('max_uses_per_email') }}">
                                    </div>
                                </div>
