                ...
                <div class="card">
                  <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                      <h4 class="card-title float-left">FAQs List</h4>
                      <a href="{{route('admin.faq.create')}}" class="btn btn-primary float-right">Add</a>
                    </div>
                  </div>
                  <div class="card-body">
                          ...
                          @foreach($allData as $value)
                            <tr>
                              ...
                              <td class="text-nowrap">
                                  <a href="{{route('admin.faq.edit', $value->id)}}" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Edit</a>
                                  <form action="{{ route('admin.faq.destroy', $value->id) }}" method="POST" style="display: inline-block;">
                                      @csrf
                                      @method('DELETE')
