                ...
                <div class="col-md-8">
                    <div class="card shadow">
                        <div class="card-header bg-light">
                            <h4 class="mb-0">Edit Journal Post</h4>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.journal.update', $data->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                                <!-- Title -->
                                <div class="mb-3 row">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-9">
                                        <textarea class="form-control" rows="3" name="excerpt" id="excerpt">{{$data->excerpt}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-9">
                                        <textarea class="form-control" rows="8" name="body" id="body">{{$data->body}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="date" class="form-control" name="published_at" id="published_at" value="{{ $data->published_at ? \Carbon\Carbon::parse($data->published_at)->format('Y-m-d') : '' }}">
                                    </div>
                                </div>
